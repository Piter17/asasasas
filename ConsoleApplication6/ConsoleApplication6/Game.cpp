...
int Game::Run()
{
    ...
    _display.itemsToDraw.emplace_back(new Text(400, 300, "Lubie placki", al_map_rgb(255, 0, 0), AlignCenter, fontDescriptor("arial.ttf", 12)));
    _display.itemsToDraw.emplace_back(new Text(400, 320, "Lubie placki", al_map_rgb(0, 255, 0), AlignLeft, fontDescriptor("arial.ttf", 12)));
    _display.itemsToDraw.emplace_back(new Text(400, 280, "Lubie placki", al_map_rgb(0, 0, 255), AlignRight, fontDescriptor("arial.ttf", 12)));
